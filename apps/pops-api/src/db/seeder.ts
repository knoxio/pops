...
export function seedDatabase(db: BetterSqlite3.Database): void {
  ...
  const run = db.transaction(() => {
    ...
    const locations = [
      ...
      { id: "loc-work", name: "Work Office", parent_id: null, sort_order: 3 },
      // Home children
      ...
      { id: "loc-bathroom", name: "Bathroom", parent_id: "loc-home", sort_order: 6 },
      { id: "loc-hallway", name: "Hallway", parent_id: "loc-home", sort_order: 7 },
      ...
      { id: "loc-couch", name: "Behind Couch", parent_id: "loc-living", sort_order: 2 },
      // Bedroom sub-locations
      { id: "loc-wardrobe", name: "Wardrobe Right Door", parent_id: "loc-bedroom", sort_order: 0 },
      { id: "loc-bedside", name: "Bedside Table", parent_id: "loc-bedroom", sort_order: 1 },
      { id: "loc-wardrobe-left", name: "Wardrobe Left Door", parent_id: "loc-bedroom", sort_order: 2 },
      ...
      { id: "loc-fridge", name: "Fridge Area", parent_id: "loc-kitchen", sort_order: 2 },
      ...
      { id: "loc-under-desk", name: "Under Desk", parent_id: "loc-office", sort_order: 2 },
      // Other sub-locations
      ...
      { id: "loc-storage-shelf", name: "Storage Shelf", parent_id: "loc-storage", sort_order: 0 },
      { id: "loc-hallway-closet", name: "Hallway Closet", parent_id: "loc-hallway", sort_order: 0 },
    ];
    ...
    const homeInventory = [
      ...
      {
        id: "inv-011",
        item_name: 'Dell U2723QE 27" Monitor',
        brand: "Dell",
        model: "U2723QE",
        item_id: null,
        room: "Home Office",
        ...
        purchased_from_name: "Amazon AU",
        asset_id: "MON-001",
        notes: "4K USB-C monitor. Connected via hub. Built-in KVM.",
        location_id: "loc-desk",
      },
      {
        id: "inv-012",
        ...
        warranty_expires: "2025-06-01",
        replacement_value: 229.0,
        resale_value: 150.0,
        purchase_transaction_id: null,
        purchased_from_id: "10000000-0000-4000-8000-000000000008",
        purchased_from_name: "Apple",
        asset_id: "ATV-001",
        notes: "HDMI 1 on Samsung TV. Plex, Netflix, Disney+.",
        location_id: "loc-tv-unit",
      },
      {
        id: "inv-013",
        item_name: "Sonos Beam Gen 2",
        brand: "Sonos",
        model: "Beam Gen 2",
        item_id: null,
        room: "Living Room",
        ...
        warranty_expires: "2025-12-25",
        replacement_value: 699.0,
        resale_value: 400.0,
        purchase_transaction_id: null,
        purchased_from_id: "10000000-0000-4000-8000-000000000010",
        purchased_from_name: "JB Hi-Fi",
        asset_id: "AUDIO-002",
        notes: "Connected to TV via eARC. Supports Dolby Atmos.",
        location_id: "loc-tv-unit",
      },
      {
        id: "inv-014",
        ...
        warranty_expires: "2026-09-20",
        replacement_value: 1849.0,
        resale_value: 1200.0,
        purchase_transaction_id: null,
        purchased_from_id: "10000000-0000-4000-8000-000000000008",
        purchased_from_name: "Apple",
        asset_id: "PHONE-001",
        notes: "256GB Natural Titanium. AppleCare+ until 2026.",
        location_id: "loc-bedside",
      },
      {
        id: "inv-015",
        item_name: "N95 Mini PC",
        brand: "Beelink",
        model: "Mini S12 Pro",
        item_id: null,
        room: "Home Office",
        ...
        replacement_value: 299.0,
        resale_value: 150.0,
        purchase_transaction_id: null,
        purchased_from_id: "10000000-0000-4000-8000-000000000006",
        purchased_from_name: "Amazon AU",
        asset_id: "SRV-001",
        notes: "POPS home server. Runs Docker, Cloudflare Tunnel. Connected via ethernet.",
        location_id: "loc-under-desk",
      },
      {
        id: "inv-016",
        ...
        replacement_value: 399.0,
        resale_value: 200.0,
        purchase_transaction_id: null,
        purchased_from_id: "10000000-0000-4000-8000-000000000008",
        purchased_from_name: "Apple",
        asset_id: "AUDIO-003",
        notes: "USB-C model. AppleCare+.",
        location_id: "loc-bedside",
      },
      {
        id: "inv-017",
        ...
        warranty_expires: null,
        replacement_value: 79.0,
        resale_value: 20.0,
        purchase_transaction_id: null,
        purchased_from_id: "10000000-0000-4000-8000-000000000009",
        purchased_from_name: "Bunnings",
        asset_id: null,
        notes: "Seasonal use. Stored in cage.",
        location_id: "loc-storage-shelf",
      },
      {
        id: "inv-018",
        item_name: "Logitech MX Keys Keyboard",
        brand: "Logitech",
        model: "MX Keys",
        item_id: null,
        room: "Home Office",
        ...
        purchase_date: "2024-11-15",
        warranty_expires: "2026-11-15",
        replacement_value: 179.0,
        resale_value: 100.0,
        purchase_transaction_id: null,
        purchased_from_id: "10000000-0000-4000-8000-000000000010",
        purchased_from_name: "JB Hi-Fi",
        asset_id: "KB-001",
        notes: "Paired to MacBook via Bluetooth. USB-C charging.",
        location_id: "loc-desk",
      },
      {
        id: "inv-019",
        ...
        purchase_date: "2024-11-15",
        warranty_expires: "2026-11-15",
        replacement_value: 149.0,
        resale_value: 80.0,
        purchase_transaction_id: null,
        purchased_from_id: "10000000-0000-4000-8000-000000000010",
        purchased_from_name: "JB Hi-Fi",
        asset_id: "MOUSE-001",
        notes: "Paired to MacBook via Bluetooth.",
        location_id: "loc-desk",
      },
      {
        id: "inv-020",
        ...
        warranty_expires: null,
        replacement_value: 45.0,
        resale_value: null,
        purchase_transaction_id: null,
        purchased_from_id: null,
        purchased_from_name: "St John Ambulance",
        asset_id: null,
        notes: "Check expiry dates annually. Last checked: 2026-01.",
    ...
    // -------------------------------------------------------------------------
    const connections = [
      // Living room entertainment chain
      ["inv-007", "inv-003"], // PB-001 (power board) → Samsung TV
      ["inv-003", "inv-006"], // Samsung TV → HDMI cable
      ["inv-006", "inv-012"], // HDMI cable → Apple TV
      ["inv-007", "inv-012"], // PB-001 → Apple TV (power)
      ["inv-003", "inv-013"], // Samsung TV → Sonos Beam (eARC)
      ["inv-007", "inv-013"], // PB-001 → Sonos Beam (power)
      // Office desk chain
      ["inv-001", "inv-008"], // MacBook → USB-C Hub
      ["inv-008", "inv-011"], // USB-C Hub → Dell Monitor
      ["inv-008", "inv-009"], // USB-C Hub → Ethernet cable
      ["inv-009", "inv-015"], // Ethernet cable → N95 Mini PC (network)
      ["inv-010", "inv-001"], // PB-002 (office power) → MacBook (charger)
      ["inv-010", "inv-011"], // PB-002 → Dell Monitor (power)
      ["inv-010", "inv-015"], // PB-002 → N95 Mini PC (power)
      // Peripherals
      ["inv-001", "inv-018"], // MacBook → MX Keys (Bluetooth)
      ["inv-001", "inv-019"], // MacBook → MX Master 3S (Bluetooth)
      ["inv-001", "inv-002"], // MacBook → Sony headphones (Bluetooth)
      // Apple ecosystem
      ["inv-014", "inv-016"], // iPhone → AirPods (paired)
    ];

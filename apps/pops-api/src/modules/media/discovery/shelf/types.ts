...
export interface ShelfDefinition {
  ...
  /**
   * When true, all instances generated by this definition are always included
   * in the session (prepended before random selection) whenever they produce
   * results. Pinned shelves bypass the `MAX_LOCAL_PER_WINDOW` constraint and
   * other variety filters.
   */
  pinned?: boolean;
  /**

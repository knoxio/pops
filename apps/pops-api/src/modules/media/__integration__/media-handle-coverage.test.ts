...
const MEDIA_INPUTS: PillarSmokeInputs = {
  ...
  'media.tvShows.listSeasons': { showId: 1 },
  ...
  'media.watchHistory.progress': { mediaType: 'movie', mediaId: 1 },
  'media.watchHistory.batchProgress': { items: [] },
  ...
  'media.discovery.contextPicks': { context: { app: null, page: null } },
  'media.discovery.genreSpotlight': {},
  'media.discovery.genreSpotlightPage': { genre: 'Drama' },

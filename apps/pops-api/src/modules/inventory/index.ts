import { inventoryManifest as ownInventoryManifest } from '@pops/inventory-contract/settings';
...
const inventorySettings: SettingsManifest =
  findSettingsManifest(discoveredSettings, 'inventory') ?? ownInventoryManifest;

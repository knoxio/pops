...
const INVENTORY_INPUTS: PillarSmokeInputs = {
  ...
  'inventory.locations.getItems': { id: 'nonexistent-location-id' },
  'inventory.locations.children': { id: 'nonexistent-location-id' },
  'inventory.locations.deleteStats': { id: 'nonexistent-location-id' },
  'inventory.connections.listForItem': { itemId: 'nonexistent-item-id' },
  'inventory.connections.trace': { fromItemId: 'nonexistent-item-id' },

 ...
 * `PROMPT_VERSION_SCREENSHOT` whenever the prompt body changes — the
 * version is written into every `ai_inference_log` row so historic
 * extractions remain comparable.
 */

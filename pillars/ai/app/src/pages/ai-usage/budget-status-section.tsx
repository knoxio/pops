...
import { aiBudgetsGetBudgetStatus } from '../../ai-api/index.js';

import type { AiBudgetsGetBudgetStatusResponse } from '../../ai-api/types.gen.js';
...
export function BudgetStatusSection() {
  const { data: budgetStatuses, isLoading } = useQuery<AiBudgetsGetBudgetStatusResponse>({
    queryKey: ['ai', 'aiBudgets', 'getBudgetStatus'],

...
function aiSchemaTransformer({ schema }: { schema: unknown }): OpenApiSchema | null {
...
function main(): void {
  const document = generateOpenApi(
    ...
    {
      schemaTransformer: aiSchemaTransformer,
  ...
  const outFile = resolve(HERE, '..', 'openapi', 'ai.openapi.json');
  ...
  process.stdout.write(`[ai] wrote OpenAPI projection to ${outFile}\n`);
}

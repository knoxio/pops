/**
 * Session-assembly helpers: candidate scoring (variety + context bonuses),
 * weighted sampling, and shelf-id predicates.
 *
 * Ported from the monolith `shelf/session-helpers.ts`.
 */
...
/** Candidate score with a variety bonus (vs last category) + context boost. */

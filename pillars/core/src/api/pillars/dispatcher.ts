...
export interface DispatchUriOptions extends ResolveUriOptions {
   ...
   * to the in-process resolver. Defaults to `'core'` because this dispatcher
   * lives inside core. Prevents self-recursion on a misconfigured
   * `core:http://core-api:3000` env entry.
   */

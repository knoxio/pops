...
import type { coreAiObservabilityContract } from '../../contract/rest-ai-observability.js';

type Req = ServerInferRequest<typeof coreAiObservabilityContract>;

export function makeAiObservabilityHandlers(db: CoreDb) {
  return {

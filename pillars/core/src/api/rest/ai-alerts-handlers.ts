...
import type { coreAiAlertsContract } from '../../contract/rest-ai-alerts.js';

type Req = ServerInferRequest<typeof coreAiAlertsContract>;

export function makeAiAlertsHandlers(db: CoreDb) {
  return {

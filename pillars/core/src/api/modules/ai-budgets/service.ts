 ...
 * window.
 */
import { aiUsageService, type AiBudgetRow, type CoreDb } from '../../../db/index.js';
 ...
 */
export function listBudgets(db: CoreDb): Budget[] {
 ...
 */
export function upsertBudget(db: CoreDb, input: UpsertBudgetInput): Budget {
 ...
 */
export function getBudgetStatus(db: CoreDb): BudgetStatus[] {

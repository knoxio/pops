 ...
 */
import { settingsService, type CoreDb } from '../../../db/index.js';
...
export function getRetentionDays(db: CoreDb): number {
  return settingsService.getSettingValue(db, RETENTION_SETTING_KEY, DEFAULT_RETENTION_DAYS);
}
 ...
 */
export function runRetention(db: CoreDb, opts: RunRetentionOptions = {}): RetentionResult {

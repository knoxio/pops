...
/**
 * Returns ALL rules that match `description`, sorted by type-priority
 * (exact → contains → regex), with confidence/timesApplied tie-breaking

...
function financeSchemaTransformer({ schema }: { schema: unknown }): OpenApiSchema | null {
...
function main(): void {
  const document = generateOpenApi(
    ...
    {
      schemaTransformer: financeSchemaTransformer,
  ...
  process.stdout.write(`[finance] wrote OpenAPI projection to ${outFile}\n`);
}

...
| #   | PRD                                                    | Summary                                                                                             | Status |
| --- | ------------------------------------------------------ | --------------------------------------------------------------------------------------------------- | ------ |
| 027 | [AI Rule Creation](../prds/ai-rule-creation/README.md) | AI-assisted proposal generation for corrections during import (proposal + preview + approve/reject) | Done   |

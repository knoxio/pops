/**
 * Manifest type generator for `@pops/lists-contract` (Theme 13 PRD-155).
 *
 * Emits `src/manifest.generated.ts` from the contract's hand-maintained
 * surface (`types/list-item.ts`, `errors.ts`, `router.ts`) plus the version
 ...
 * byte-compares.
 *
 * Imports below intentionally pull `ListItem`, `ListsError`, and
 * `ListsRouter` so that running the generator validates that the
...
import type { ListsError } from '../src/errors.js';
import type { ListsRouter } from '../src/router.js';
import type { ListItem } from '../src/types/list-item.js';

export type SurfaceAssertion = [ListItem, ListsError, ListsRouter];

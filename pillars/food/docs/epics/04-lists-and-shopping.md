...
The generic lists/list_items model lives in the **lists pillar** (see its [schema](../../../lists/docs/prds/schema/README.md), [shell module](../../../lists/docs/prds/shell-module/README.md), [CRUD UI](../../../lists/docs/prds/crud-ui/README.md), and [shopping specialisation](../../../lists/docs/prds/shopping-specialisation/README.md) docs). This epic's remaining food-owned deliverable is the food → shopping list "Send" action that aggregates recipe-line quantities through PRD-123's unit-conversion tables and pushes them into a lists-pillar shopping list over the SDK.
...
[lists pillar docs](../../../lists/docs/README.md). PRD-142 is the remaining
food-side work and consumes that surface over the SDK.

- **PRD-142** is the food-side button + picker + aggregation. It calls the lists
  ...
  the aggregated recipe lines. **PRD-142 also requires PRD-119 amendments**
  (action-menu entry, `RecipeScaleProvider` context, two new food recipe
  endpoints) — these must be agreed alongside PRD-119's implementation, not
  deferred to PRD-142's slot.

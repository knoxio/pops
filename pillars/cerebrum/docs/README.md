...
| PRD                                                            | Summary                                                                          | Status |
| -------------------------------------------------------------- | -------------------------------------------------------------------------------- | ------ |
| [Engram File Format & CRUD](prds/engram-file-format/README.md) | File format, YAML frontmatter, templates, SQLite index, CRUD service, REST       | Done   |
| [Scope Model](prds/scope-model/README.md)                      | Hierarchical dot-notation scopes, rules engine, filtering, secret-scope blocking | Done   |
...
| PRD                                                    | Summary                                                                             | Status  |
| ------------------------------------------------------ | ----------------------------------------------------------------------------------- | ------- |
| [Indexing & Sync](prds/indexing/README.md)             | File watcher, frontmatter-to-SQLite sync, embedding trigger, cross-source re-embed  | Partial |
| [Retrieval Engine](prds/retrieval-engine/README.md)    | Semantic / structured / hybrid search, context assembly, scope-filtered retrieval   | Done    |
| [Embeddings (read surface)](prds/embeddings/README.md) | Read-only coverage view over the embeddings metadata table for cross-pillar callers | Done    |
...
| PRD                                                     | Summary                                                                               | Status  |
| ------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------- |
| [Ingestion Pipeline](prds/ingestion-pipeline/README.md) | Input channels, classification, entity extraction, scope inference, dedup, templating | Partial |
...
| PRD                                                       | Summary                                                                             | Status  |
| --------------------------------------------------------- | ----------------------------------------------------------------------------------- | ------- |
| [Query Engine](prds/query-engine/README.md)               | Natural-language Q&A, scope-aware retrieval, citation attribution, multi-domain     | Partial |
| [Document Generation](prds/document-generation/README.md) | Reports, summaries, timelines — scope-filtered, audience-aware output documents     | Done    |
| [Proactive Nudges](prds/proactive-nudges/README.md)       | Consolidation proposals, staleness alerts, pattern detection, notification delivery | Partial |
...
| PRD                                                 | Summary                                                                        | Status  |
| --------------------------------------------------- | ------------------------------------------------------------------------------ | ------- |
| [Curation Workers](prds/curation-workers/README.md) | Pruner, consolidator, linker, auditor — the four Glia worker types             | Partial |
| [Trust Graduation](prds/trust-graduation/README.md) | Three-phase progression, approval tracking, immutable log, reversible demotion | Done    |
...
| PRD                                         | Summary                                                                            | Status  |
| ------------------------------------------- | ---------------------------------------------------------------------------------- | ------- |
| [Ego Core](prds/ego-core/README.md)         | Conversation engine, scope negotiation, context assembly, conversation persistence | Partial |
| [Ego Channels](prds/ego-channels/README.md) | Shell chat panel, MCP tools for Claude Code, Moltbot, CLI                          | Partial |
...
| PRD                                           | Summary                                                                               | Status  |
| --------------------------------------------- | ------------------------------------------------------------------------------------- | ------- |
| [Reflex System](prds/reflex-system/README.md) | Reflex definitions, trigger types, action dispatch, management surface, execution log | Partial |
...
| PRD                                                       | Summary                                                                                | Status  |
| --------------------------------------------------------- | -------------------------------------------------------------------------------------- | ------- |
| [Plugin Architecture](prds/plugin-architecture/README.md) | Adapter interface, lifecycle manager, ingestion filters, plugin registry, REST surface | Partial |
...
| PRD                               | Summary                                                                               | Status  |
| --------------------------------- | ------------------------------------------------------------------------------------- | ------- |
| [Debrief](prds/debrief/README.md) | Session/result tables, soft pointers into media, best-effort post-commit REST surface | Partial |

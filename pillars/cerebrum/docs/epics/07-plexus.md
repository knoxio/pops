...
| PRD                                                                | Summary                                                                                  | Status  |
| ------------------------------------------------------------------ | ---------------------------------------------------------------------------------------- | ------- |
| [Plugin Architecture](../prds/plugin-architecture/README.md)       | Adapter interface, lifecycle management, plugin registry, configuration, error isolation | Partial |
| [Core Integration Adapters](../ideas/core-integration-adapters.md) | Email, calendar, and GitHub adapters as reference implementations                        | Idea    |

`plugin-architecture` owns the adapter contract and must land before the reference adapters — the adapters implement the interface that the architecture defines. The concrete email/calendar/GitHub adapters are not yet built; they are tracked as [core-integration-adapters](../ideas/core-integration-adapters.md).

/**
 * Snapshot tests for the registry REST OpenAPI projection (pillar formerly
 * named `core`).
 *
 ...
 * supersedes the previous tRPC-era snapshot: during the REST migration the
 * document grows one domain at a time as each tRPC slice converts. The
 ...
 * the shape of the migrated domains.
 */

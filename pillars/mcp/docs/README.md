...
Full per-tool surface, rules, and edge cases: [Tool Inventory PRD](prds/tool-inventory/README.md). Gateway plumbing (transport, lifecycle, container, CI publish, config) is the central platform spec — see [PRD-102](../../../docs/themes/00-platform/prds/102-mcp-server/README.md); this tree does not duplicate it.

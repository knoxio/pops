...
| #   | PRD                                                                    | Summary                                                                                                                                               | Status |
| --- | ---------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| 047 | [Location Tree Management](../prds/location-tree-management/README.md) | Tree browser, CRUD operations, drag-and-drop reordering, circular reference prevention, item browsing per location, mobile fallback for drag-and-drop | Done   |

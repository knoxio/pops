...
| #   | PRD                                                            | Summary                                                                                                                      | Status |
| --- | -------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | ------ |
| 043 | [Inventory Data Model & API](../prds/data-model-api/README.md) | Items table, locations tree (self-referential parent_id), connections junction table, photos, asset IDs, notes, tRPC routers | Done   |

...
import { SlugAlreadyRegisteredError, type SlugKind } from '../errors';
import { ingredients, slugRegistry, type IngredientRow } from '../schema';
...
export type { FoodDb } from './internal';
export { MAX_INGREDIENT_DEPTH } from './internal';

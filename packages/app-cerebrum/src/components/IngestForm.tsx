...
function getSubmitLabel(
  ...
  if (isInferring) return t('ingest.inferringScopes');
...
function FormActions({
  ...
  return (
    <div className="flex justify-end pt-4">
      ...
      >
        {getSubmitLabel(t, isInferring, isSubmitting)}
      </Button>
    </div>
  );
}

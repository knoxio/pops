...
|---|-------|---------|----------------|
| 01 | [us-01-item-metadata](us-01-item-metadata.md) | Header with name/assetId/condition, metadata section, location breadcrumb, notes, purchase link, delete modal | Yes |
| 02 | [us-02-photo-gallery](us-02-photo-gallery.md) | Photo gallery with primary display, thumbnail strip, lightbox view, placeholder | Yes |
| 03 | [us-03-connections-section](us-03-connections-section.md) | Connections list with names/assetIds, "Trace Chain" button, chain visualisation | Yes |
| 04 | [us-04-warranty-status](us-04-warranty-status.md) | Warranty status indicator with colour-coded badges and expiry calculation | Yes |

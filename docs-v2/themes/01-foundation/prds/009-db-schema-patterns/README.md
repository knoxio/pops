...
|---|-------|---------|----------------|
| 01 | [us-01-migration-conventions](us-01-migration-conventions.md) | Establish migration naming, template file, runner, fresh DB path | No (first) |
| 02 | [us-02-entity-types](us-02-entity-types.md) | Add entity type system (type column, supported values) | Blocked by us-01 |
| 03 | [us-03-cross-domain-fks](us-03-cross-domain-fks.md) | Document FK patterns, formalise existing cross-domain links, create schema registry | Blocked by us-01 |
| 04 | [us-04-settings-table](us-04-settings-table.md) | Create core settings table for dynamic application configuration | Blocked by us-01 |
| 05 | [us-05-seed-data](us-05-seed-data.md) | Create comprehensive seed dataset for dev and e2e testing | Blocked by us-01 |

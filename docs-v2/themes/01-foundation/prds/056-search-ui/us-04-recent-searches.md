...
As a user, I want to see my recent searches when the search bar is empty so that I can quickly repeat past searches.
...
Client-side only — no server storage for search history.

...
As a user, I want to navigate search results with keyboard so that I can search without touching the mouse.
...
Standard command palette / search dropdown keyboard patterns. Similar to VS Code's Cmd+P.

...
| [`03-frontend-rest-cutover.md`](./03-frontend-rest-cutover.md)   | Browser client → REST, `app-finance` conversion, remove tRPC shims, drop `TRPC_PILLARS`             | **Track B ✅ · Track C ✅ · Track A ✅ — `app-finance` fully off `@pops/api` (#3455)**; **B3 + `TRPC_PILLARS` + browser client now UNBLOCKED** (02 landed #3457 — the monolith `/trpc` is gone)                                        |

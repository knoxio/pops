...
| 10  | [Modular Module Runtime](epics/10-modular-module-runtime.md) | Manifest contract + env-driven loader (`POPS_APPS`/`POPS_OVERLAYS`); lint-enforced module boundaries; overlay category; build-time registry consumed by every cross-cutting concern | In progress |

...
| #   | PRD                                                                                              | Summary                                                                                                                                                                             | Status |
| --- | ------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| 056 | [Search UI](../../../../pillars/shell/docs/prds/search-ui/README.md)                             | TopBar search bar, results panel with context-aware sections (current app first), keyboard navigation, recent searches, result linking via URIs                                     | Done   |
...
| 058 | [Contextual Intelligence](../../../../pillars/shell/docs/prds/contextual-intelligence/README.md) | Shell tracks active app, page, entity being viewed. Exposes via context/store for Search, AI Overlay, and future consumers                                                          | Done   |

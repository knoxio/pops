...
in [Federated query orchestrator](../federated-query-orchestrator/README.md) and
[Partial failure semantics](../partial-failure-semantics/README.md); the cross-pillar
merge lives in [Ranking strategy](../ranking-strategy/README.md).
...
- **Federated query orchestrator** (fan-out, timeout, partial-failure) — see
  [Federated query orchestrator](../federated-query-orchestrator/README.md).
- **Ranking strategy** (per-pillar weights, merge algorithm) — see
  [Ranking strategy](../ranking-strategy/README.md).

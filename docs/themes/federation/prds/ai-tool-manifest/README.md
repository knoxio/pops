...
covered by [Dynamic tool list](../dynamic-tool-list/README.md) and
[Tool-call routing](../tool-call-routing/README.md).
...
that projection belongs to [Dynamic tool list](../dynamic-tool-list/README.md).
...
- **Tool implementation lives on the pillar.** The manifest declares the
  ...
  invoked by [Tool-call routing](../tool-call-routing/README.md).
...
- Building the per-request tool list from the registry snapshot →
  [Dynamic tool list](../dynamic-tool-list/README.md).

...
| PRD                                                                         | Summary                                                                                                                                                            | Status    |
| --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------- |
| [Federated query orchestrator](prds/federated-query-orchestrator/README.md) | Runtime federated-search service: project search-capable pillars from the registry, fan out over the SDK, decorate + merge + rank into one `SearchAllResult`       | To Review |
| [Partial failure semantics](prds/partial-failure-semantics/README.md)       | Failure-isolation guarantee of federated `POST /search`: a single down pillar never sinks the search; internal failure classes for future partial-result surfacing | To Review |
...
| PRD                                                      | Summary                                                                                                                                                                                         | Status    |
| -------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| [Dynamic AI tool list](prds/dynamic-tool-list/README.md) | `buildToolList()` projects every healthy pillar's `ai.tools` slot into the live tool set per request; membership resolved, not compiled                                                         | To Review |
| [Tool-call routing](prds/tool-call-routing/README.md)    | `invokeTool()` dispatches a tool call to the owning pillar and normalises every outcome into a discriminated `ToolResult` that always resolves; provider adapter formats for Anthropic / OpenAI | Done      |

...
- The GHCR image contract, compose deployment artifact, secrets layout, and versioning (the [Application Packaging & GHCR Contract](application-packaging.md) PRD)

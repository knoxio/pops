...
- **22 PRDs Done.** Foundation, registry/SDK, settings dimension, dynamic AppRouter, shell decoupling, db-types decomposition (7/8 USs), PRD-249 (cerebrum.embeddings.\* SDK closed via #3275 + #3292), PRD-250 pillar-sdk hardening.
...
_(empty — PRD-249 closed via #3275 + #3292)_

...
| 14  | [Cross-language interop](../federation/epics/cross-language-interop.md)         | REST wire-format spec that lets non-TS pillars (Rust, Go, Python) drop in as peers — Rust `contacts` proves it (relocated to the Federation theme) | In progress |

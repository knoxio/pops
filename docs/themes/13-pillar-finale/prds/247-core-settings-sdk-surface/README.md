...
>
> Status: **In progress** — US-01 core-api router mounted; US-04 integration test landed (`apps/pops-core-api/src/__tests__/core-settings-sdk-itest.test.ts`); in-monolith rename + ensure-expose, US-02 pattern doc, and US-03 burn-down outstanding. Direct unblock for [PRD-246](../246-shell-api-pillar-decoupling/README.md) US-04 Site 8 (15 media files reading `@pops/core-db` directly).

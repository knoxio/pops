...
>
> Status: **Done** — all relocations US-01 … US-05 shipped; US-06 closed alongside [PRD-240 US-05](../240-settings-as-manifest-dimension/us-05-delete-static-barrels-and-legacy-subpath.md) (folded cleanup)
...
| 06  | [us-06-drop-legacy-subpath](us-06-drop-legacy-subpath.md)                 | Delete `packages/module-registry/src/settings/` + `./settings` exports entry. Drop `pillar-sdk`'s `@pops/module-registry` workspace dep. Close PRD-238 US-02 as Done. **Done** — closed via [PRD-240 US-05](../240-settings-as-manifest-dimension/us-05-delete-static-barrels-and-legacy-subpath.md). | Blocked by us-01 … us-05 |

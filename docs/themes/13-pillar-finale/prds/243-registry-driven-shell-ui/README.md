...
| 05  | [us-05-external-pillar-ui-loading](us-05-external-pillar-ui-loading.md)       | **Stub — Done.** Enumerates the three candidate mechanisms (lazy `import()` of advertised `assetsBaseUrl`, module federation, iframe per pillar) with pros/cons and a recommendation (A primary, C opt-in, B rejected for Epic 10). Defers decision to a successor PRD outside Theme 13. No implementation in PRD-243. | Blocked by us-01; doc-only stub |

...
| Bucket                        | Count |
| ----------------------------- | ----: |
| Procedure call sites          |     4 |
| Wiring / utility references   |     5 |
| **Total `trpc.*` references** |     9 |
| Files touched                 |     6 |

> Batch 1 of PRD-204 migrated the 7 unblocked trivial sites (rows 3, 4, 11, 12, 14, 15, 16) — the original totals of 16 references / 10 files now stand at 9 references / 6 files.

### By category

| Category | Count | Notes                                                                                                                                                                                                           |
| -------- | ----: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Trivial  |     3 | `core.features.set*` mutations in `use-feature-mutations.ts` (rows 8–10). Blocked behind the medium `useUtils` reference (row 7) — direct renames once that's resolved.                                         |

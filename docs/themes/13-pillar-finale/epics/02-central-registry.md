...
| 228                                                                        | Dynamic pillar registration        | External-pillar drop-in: register/heartbeat/deregister + eviction; dispatcher renders from registry | Done        |
| [prod-registry-driven-nginx](../prds/prod-registry-driven-nginx/README.md) | Production registry-driven nginx   | Deploy boot-render + watcher into the prod shell image; repoint the registry fetch to REST          | Done        |

...
| **[Foundation](foundation/README.md)**                | Design system + app runtime: shell, UI library, REST contract, DB patterns, search, settings, feature toggles, and the manifest/plugin contract every pillar runs on     | 1     | Done (Drizzle migration pending)              |
...
| **[Cerebrum](../../pillars/cerebrum/docs/README.md)** | Personal cognitive infrastructure — self-curating knowledge base that compounds over a lifetime                                                                          | 2-3   | Not started                                   |
...
| **[Pillar finale](13-pillar-finale/README.md)**       | Complete the pillar architecture: central runtime registry, contract-typed cross-pillar communication, deletion of `pops.db`, fully detached pillars                     | 3     | Not started                                   |

## App Themes

| Theme                                                   | One-liner                                                                                                                                               | Phase | Status                              |
| ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- | ----------------------------------- |
| **[Finance](../../pillars/finance/docs/README.md)**     | Budgeting, transaction tracking, wishlist, bank imports, AI categorisation                                                                              | 2     | Done (product spec not yet written) |
| **[Media](../../pillars/media/docs/README.md)**         | Movies and TV show tracking, preference learning, recommendations. Plex/Radarr/Sonarr/TMDB/TheTVDB                                                      | 2     | Done                                |
| **[Inventory](../../pillars/inventory/docs/README.md)** | Home inventory — connectivity graph, hierarchical locations, photos, Paperless-ngx receipts, insurance reports                                          | 2     | Done                                |
...
| **[Food](../../pillars/food/docs/README.md)**           | Recipes, ingredients, meal prep, multimodal ingestion (web + Instagram + text + screenshot). Links to finance (grocery spend), inventory (kitchen gear) | 4     | In progress                         |

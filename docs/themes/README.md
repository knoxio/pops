...
| **[Food](07-food/README.md)**           | Recipes, ingredients, meal prep, multimodal ingestion (web + Instagram + text + screenshot). Links to finance (grocery spend), inventory (kitchen gear) | 4     | In progress                         |

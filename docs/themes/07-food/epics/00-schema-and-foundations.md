...
| #   | PRD                                                                                        | Summary                                                                                                            | Status      |
| --- | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ | ----------- |
| 106 | [Ingredient & Variant Model](../prds/106-ingredient-model/README.md)                       | Canonical ingredients with hierarchy, variants, prep_states, aliases, `slug_registry` (global namespace)           | In progress |

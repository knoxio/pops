...
| 123 | [Conversion Table Schema & Admin](../prds/123-conversion-table/README.md)    | `unit_conversions` global + `ingredient_weights` per-ingredient; upgrades PRD-116 normalisation; admin UI         | Not started |

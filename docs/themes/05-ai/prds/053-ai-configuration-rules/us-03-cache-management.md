...
- [x] Cache stats display: total entries, approximate disk size, hit rate
- [x] "Clear stale" button: removes entries older than configurable N days
- [x] "Clear all" button with confirmation dialog
- [x] Stats refresh after clearing
- [x] Toast confirmation showing how many entries were removed

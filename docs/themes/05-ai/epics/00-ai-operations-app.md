...
| 053 | [AI Configuration & Rules](../prds/053-ai-configuration-rules/README.md) | Model selection, token budgets, prompt templates, categorisation rule viewer, cache management | Done |

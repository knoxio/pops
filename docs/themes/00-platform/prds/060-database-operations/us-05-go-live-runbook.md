...
- [x] Runbook covers: emergency recovery — if something goes wrong, how to restore from backup (references PRD-017 recovery procedure in [knoxio/homelab-infra](https://github.com/knoxio/homelab-infra))

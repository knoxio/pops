...
This is a local safety net, not a replacement for the offsite backup system (PRD-017 in [knoxio/homelab-infra](https://github.com/knoxio/homelab-infra)). The offsite backup runs on a schedule; this runs on every server startup that has pending migrations.

...
- **Requires:** Epic 01 (Database Operations — sqlite-vec uses the same migration system); Docker runtime + networks provided by `homelab-infra` PRD-013

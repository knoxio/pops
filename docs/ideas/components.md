...
Spun out of [PRD-003 Components](../themes/foundation/prds/components/README.md).
...
The Lucide icon vocabulary (PRD-003 → Action Icon Standards) is documented and
...
at which point these criteria fold back into PRD-003 as `[x]`.

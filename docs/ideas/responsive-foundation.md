...
Open work beyond the shipped [Responsive Foundation PRD](../themes/01-foundation/prds/responsive-foundation/README.md). The breakpoint system, shell mobile layout, component adaptation patterns, primitive touch targets, and empty/error/page-header conventions are built. The items below are not.

...
Split out from PRD-097 (Module Import Boundaries) during the greenfield rewrite. The enforced parts of PRD-097 shipped (see [the PRD](../themes/01-foundation/prds/module-import-boundaries/README.md)). What follows is the part of the original spec that was either superseded by the federation isolation model or never built.

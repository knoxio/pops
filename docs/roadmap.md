...
| Ingest (input pipeline)       | In progress | PRD-081 in progress — pipeline stages (US-02–US-06), capture-first manual surface (US-01), post-ingest review (US-07), and scope reconciliation (US-10) done; bulk paste (US-08) and global hotkey (US-09) pending |
